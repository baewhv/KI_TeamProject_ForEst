...
public class CharacterCutsceneDataProperty : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.isExpanded)
        {
            ...
            var GetInGamePosition = property.FindPropertyRelative("GetInGamePosition");
            var _characterType = property.FindPropertyRelative("character");

            if (_characterType.enumValueIndex != (int)ESelectedCharacter.Seed_B)
            {
                EditorGUILayout.PropertyField(GetInGamePosition,
